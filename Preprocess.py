...
def rgbd_to_pcd(count):
    source_color = o3d.io.read_image('./data/align_test%d.png' % count)
    source_depth = o3d.io.read_image('./data/align_test_depth%d.png' % count)
    ...
    with o3d.utility.VerbosityContextManager(o3d.utility.VerbosityLevel.Debug) as cm:
        labels = np.array(
            outlier_cloud.cluster_dbscan(eps=0.0145,  # Epsilon defines the distance between to neighbors in a cluster
    ...
    o3d.io.write_point_cloud("pcd/result{}.pcd".format(i), interest_pcd)
